window["commonninja-js-sdk"] = (function (e) {
    ...
    function (e, t, n) {
                    ...
                    if (e.data) {
                        ...
                        switch (t.type) {
                            ...
                            case m.e.COMMONNINJA_ENGAGEMENT_EVENT:
                                Object(v.d)(t.compId, m.b.ENGAGEMENT, t.eventType, { eventVersion: t.version || "", eventSubType: t.eventSubType, entityPath: t.entityPath });
                                break;
        ...
        function d(e) {
            ...
            if (!t || !t.widgetElm) return Object(g.a)('Could not report view for plugin "'.concat(e, '".')), { bounding: {}, inViewport: !1 };
        ...
        function f(e, t, n) {
            ...
            var d = t !== window.location.href,
                u = Object.keys(window[m.f].installedPlugins).find(function (t) {
                    return window[m.f].installedPlugins[t].widgetId === e;
                }),
                f = window[m.f].installedPlugins[u];
            if (f && f.widgetId && (n || f.placeholderElm.className.includes("cn-global"))) return void Object(g.a)("Global widget already installed", e);
            Object(g.a)("Installing global widget", e);
            var p = document.createElement("div");
            if (((p.className = "commonninja_component pid-".concat(e, " ").concat(n ? "" : "cn-global")), !d && !n)) {
                var w = document.querySelector(".pid-".concat(f.widgetId));
                w && w.remove(), (f.placeholderElm = p);
            }
            if ((n || document.body.appendChild(p), !t || t.includes("srcdoc")))
                            ...
                            if (l.contentWindow) {
                                ...
                                if (s) {
                                    ...
                                    s.classList.forEach(function (e) {
                                        var t;
                                        e.startsWith("hid-") && ((t = e.split("hid-")), (d = t[1]));
                                    }),
                                        p.classList.add("hid-".concat(d)),
                                        n && (null === (o = l.parentElement) || void 0 === o || o.appendChild(p)),
                                        null === (a = null === (r = l.contentWindow.CommonNinja) || void 0 === r ? void 0 : r.destroy) || void 0 === a || a.call(r),
                                        (l.style.display = "none"),
                                        s.remove(),
                                        null === (c = window[m.f]) || void 0 === c || c.init();
                                }
                            }
                        } catch (e) {}
                    })(b);
            var O = document.querySelector('iframe[src="'.concat(t, '"]'));
            O && ((O.style.display = "none"), n && (null === (l = O.parentElement) || void 0 === l || l.appendChild(p))), null === (s = window[m.f]) || void 0 === s || s.init();
        }
        function p(e, t, n) {
            var i = window[m.f].installedPlugins[e];
            if (i) {
        ...
        function w(e, t, n) {
            if ((Object(g.a)("scroll triggered", t, n), "top" === t)) window.scroll({ behavior: "smooth", top: 0 });
            else if ("bottom" === t) window.scroll({ behavior: "smooth", top: window.outerHeight });
            else {
                        ...
                        (n = new XMLHttpRequest()),
                            ...
                            (n.onreadystatechange = function () {
                                if (4 === this.readyState) {
                                    var e = "{}";
                                    (e = 200 === this.status ? n.responseText : JSON.stringify({ success: !1, message: "Could not make request." })), t && t(e);
                                }
                            });
                    } catch (e) {
                        t && t(JSON.stringify({ success: !1, message: e.message || "Could not make request." }));
                    }
                    return [2];
                });
            });
                        ...
                        "childList" === i.type &&
                            i.removedNodes.forEach(function (e) {
                                Object.keys(window[m.f].installedPlugins || {}).forEach(function (t) {
                                    ...
                                    e === o &&
                                        (Object(g.a)("Widget ".concat(i.id, " was removed, reloading.")),
                                        window.setTimeout(function () {
            ...
            Object(O.e)({ scrollPercantage: o, lastActivity: Date.now() }),
                Object.keys(window[m.f].installedPlugins).map(function (e) {
                    ...
                    return i && t.widgetElm
                        ? (Object(h.c)(t.widgetElm, { inViewport: o, type: m.e.COMMONNINJA_PARENT_WINDOW_SCROLL, fromTop: i.top, windowHeight: window.innerHeight, compId: t.widgetId }), t)
                        : void Object(g.a)('Could not calculate bounding for plugin "'.concat(e, '".'));
                });
        }
    ...
    function (e, t, n) {
        ...
        function o() {
            ...
            return {
                ...
                timezone:
                    (null === (o = null === (n = null === (t = null === Intl || void 0 === Intl ? void 0 : Intl.DateTimeFormat) || void 0 === t ? void 0 : t.call(Intl)) || void 0 === n ? void 0 : n.resolvedOptions) || void 0 === o
                        ? void 0
                        : o.call(n).timeZone) || "",
                ...
                hasExitIntent: !1,
                lastElementClick: [],
                websiteSession: { firstVisit: Date.now(), lastVisit: Date.now(), clicks: 0, pages: 0, visits: 0 },
                widgetSession: {},
                version: 1,
                dimensions: { width: window.innerWidth, height: window.outerHeight },
            };
        }
        function r() {
            try {
        ...
        function a(e) {
            ...
            return (
                Object.keys(window[d.f].installedPlugins).map(function (e) {
                    ...
                    return Object(u.c)(t.frameElm || t.widgetElm, { type: d.e.COMMONNINJA_USER_CONTEXT_UPDATED, compId: t.widgetId, userContext: n }), t;
                }),
                e
            );
        }
        function c() {
            ...
            (t.hasExitIntent = !1),
                (t.currentUrl = n),
                (t.currentPage = c),
                (t.domain = null === window || void 0 === window ? void 0 : window.location.origin),
                (t.device = i()),
                (t.lastActivity = Date.now()),
                (t.websiteSession = f(f({}, t.websiteSession), { lastVisit: Date.now(), clicks: 0, visits: ((null === (e = t.websiteSession) || void 0 === e ? void 0 : e.visits) || 0) + 1 })),
                t.pageSession || (t.pageSession = {}),
                t.pageSession[c] || ((t.pageSession[c] = { clicks: 0, visits: 0, firstVisit: Date.now(), lastVisit: Date.now() }), (t.websiteSession.pages += 1)),
        ...
        function s(e) {
            var t,
                n,
                i,
                o = (null === (n = r()) || void 0 === n ? void 0 : n.widgetSession) || {},
                a = (null === (i = o[e]) || void 0 === i ? void 0 : i.views) || [];
            a.length > 100 && a.splice(0, a.length - 100), l({ widgetSession: f(f({}, o), ((t = {}), (t[e] = { views: p(p([], a, !0), [Date.now()], !1) }), t)) });
        }
    ...
    function (e, t, n) {
        ...
        !(function () {
                ...
                for (var e, t = [], n = document.getElementsByTagName("iframe"), i = 0; i < n.length; i++) {
                    ...
                    try {
                        if (o.contentDocument) {
                            var r = null === (e = o.contentDocument) || void 0 === e ? void 0 : e.querySelector(I);
                            r
                                ? ((r.frameContext = "iframe-doc"), (r.frameElm = o), t.push(r))
                                : (o.onload = function () {
                                      N();
                                  });
                        }
            ...
            function t() {
                var e = m([], Array.from(document.querySelectorAll(I)), !0);
                Object(s.a)("Found ".concat(e.length, " plugins on page.")),
                    e.forEach(function (e, t) {
                        ...
                        if ((o || ((o = Object(c.a)(6)), (e.className = "".concat(e.className, " hid-").concat(o))), (n = "".concat(i, "_").concat(o)), S[n])) return void Object(s.a)('Plugin "'.concat(n, '" was already initiated.'));
                        var r = {
                            id: n,
                            placeholderElm: e,
                            widgetId: i,
                    ...
                    return w(this, function (t) {
                        return [
                            ...
                            new Promise(function (t) {
                                ...
                                e.type && (a += "?componentType=".concat(e.type)),
                                    A && (a.includes("?") ? (a += "&crawler=true") : (a += "?crawler=true")),
            ...
            function v(t, n) {
                var i,
                    o,
                    r =
                        document.querySelector("".concat(I, ".pid-").concat(t, ".hid-").concat(n, " div")) ||
                        document.querySelector("".concat(I, '[comp-id="').concat(t, '"].hid-').concat(n, " div")) ||
                        (null === (i = document.querySelector("".concat(I, ".pid-").concat(t, ".hid-").concat(n))) || void 0 === i ? void 0 : i.shadowRoot) ||
                        (null === (o = document.querySelector("".concat(I, '[comp-id="').concat(t, '"].hid-').concat(n))) || void 0 === o ? void 0 : o.shadowRoot);
                if (r) return r;
            ...
            function h(e) {
                var t, i, r;
                return p(this, void 0, void 0, function () {
                    var a, c, p, m, h, g, b, O, y, E, N, _, I, M;
                    return w(this, function (w) {
                        switch (w.label) {
                            case 0:
                                return "iframe-src" === e.frameContext
                                    ? (Object(s.a)('Plugin "'.concat(e.id, '" is in iframe-src context, no need to install')), [2])
                                    : S[e.id]
                                    ? (null === (t = S[e.id]) || void 0 === t ? void 0 : t.processing)
                                        ? (Object(s.a)('Plugin "'.concat(e.id, '" is already processing')), [2])
                                        : ((S[e.id].processing = !0),
                                          (a = v(e.widgetId, e.id.split("_")[1]))
                                              ? (Object(s.a)('Plugin "'.concat(e.id, '" was already installed.')), (e.widgetElm = a), (S[e.id].processing = !1), [2])
                                              : (Object(s.a)('Installing plugin "'.concat(e.id, '".')),
                                                (c = "border: none; margin: 0; padding: 0; background: none; transition: all 0.2s ease;"),
                                                (p = "".concat(c, ";")),
                                                (m = Object(d.a)(e.refUrl, e.widgetId)),
                                                (h = e.props || ""),
                                                (g = encodeURIComponent(e.refUrl.split("?")[0])),
                                                (b = "refUrl=".concat(g, "&props=").concat(encodeURIComponent(h))),
                                                (e.placeholderElm.style.webkitOverflowScrolling = "touch"),
                                                (e.placeholderElm.style.transition = "all 0.2s ease"),
                                                (e.placeholderElm.style.display = "initial"),
                                                [4, n(e)]))
                                    : [2];
                            case 1:
                                if (((O = w.sent()), (y = JSON.parse(O)), (E = y.success), (N = y.message), (_ = y.data), !E || !_.html))
                                    return (
                                        (e.placeholderElm.innerHTML = '<div class="cn-error" style="text-align: center">'.concat(N || "Could not load app.", "</div>")),
                                        (e.widgetElm = e.placeholderElm.querySelector("iframe") || e.placeholderElm.querySelector("div:first-child")),
                                        [2]
                                    );
                                if ("iframe" === (I = _.renderMode || "iframe"))
                                    (e.placeholderElm.innerHTML = '<iframe\n\t\t\tstyle="'
                                        .concat(p, '"\n\t\t\ttitle="Common Ninja\'s Widget"\n\t\t\tframeborder="0"\n\t\t\tsrc="')
                                        .concat(_.html, "/")
                                        .concat(m, "?")
                                        .concat(b, '"\n\t\t\tloading="eager"\n\t\t\tallowfullscreen\n\t\t\tscrolling="no"\n\t\t>\n\t\t</iframe>')),
                                        (e.widgetElm = e.placeholderElm.querySelector("iframe")),
                                        (e.widgetElm.onload = function () {
                                            Object(l.c)(e.widgetElm, { type: o.e.COMMONNINJA_USER_CONTEXT_UPDATED, compId: e.widgetId, userContext: Object(u.b)() });
                                        });
                                else {
                                    if ("crawler" === I)
                                        return (
                                            (e.muteEvents = !0),
                                            (e.placeholderElm.innerHTML = _.html),
                                            _.adsRemoval ||
                                                ((M = null === (i = _.widgetData) || void 0 === i ? void 0 : i.appMeta),
                                                Object(f.a)(e, !1, "Free ".concat(null === M || void 0 === M ? void 0 : M.name, " Widget"), "https://www.commoninja.com/widgets/".concat(null === M || void 0 === M ? void 0 : M.slug))),
                                            (S[e.id].processing = !1),
                                            Object(s.a)('Installed plugin from crawler "'.concat(e.id, '".')),
                                            [2]
                                        );
                                    Object(s.a)('Calling CommonNinjaWidgetRenderer for plugin "'.concat(e.id, '".')),
                                        null === (r = window.CommonNinjaWidgetRenderer) ||
                                            void 0 === r ||
                                            r.call(window, {
                                ...
                                return (
                                    (null === e || void 0 === e ? void 0 : e.reportedEvents.indexOf(o.a.INSTALL)) < 0 && (Object(u.f)(e.widgetId), null === e || void 0 === e || e.reportedEvents.push(o.a.INSTALL)),
                                    S[e.id] && (S[e.id].processing = !1),
                                    Object(s.a)('Installed plugin "'.concat(e.id, '".')),
                                    [2]
                                );
                        }
                    });
                ...
                return p(this, void 0, void 0, function () {
                    ...
                    return w(this, function (n) {
                        switch (n.label) {
                            ...
                            case 2:
                                return (
                                    (e = Object.keys(S).map(function (e) {
            ...
            function O(e, t) {
                return p(this, void 0, void 0, function () {
                    return w(this, function (n) {
                        switch (n.label) {
                            case 0:
                                return j ? (Object(s.a)("Already handling reload."), [2]) : ((j = !0), Object(s.a)("Reload started for", e || "all", "skip populated: ", t), [4, window[o.f].destroy(e, t)]);
                            case 1:
            ...
            function y(e, t) {
                return p(this, void 0, void 0, function () {
                    return w(this, function (n) {
                        return (
                            Object(s.a)("Destroying widget placeholders of ".concat(e, "...")),
                            Object.keys(S).forEach(function (n) {
                                var i, o, r, a, c;
                                if (n.includes(e)) {
                                    if (null === (i = null === S || void 0 === S ? void 0 : S[n]) || void 0 === i ? void 0 : i.processing) return void Object(s.a)("Skipping destroy for processing widget", n);
                                    if (t) {
                                    ...
                                    if (
                                        (null === (r = null === (o = window.CommonNinjaWidgetRoots) || void 0 === o ? void 0 : o[n]) || void 0 === r || r.unmount(),
                                        null === (a = window.CommonNinjaWidgetRoots) || void 0 === a || delete a[n],
                                        null === (c = null === S || void 0 === S ? void 0 : S[n]) || void 0 === c ? void 0 : c.placeholderElm)
                                    ) {
                                        S[n].placeholderElm.innerHTML = "";
                                        var l = S[n].placeholderElm.cloneNode(!1);
                                        S[n].placeholderElm.replaceWith(l);
                                    }
                                    null === S || void 0 === S || delete S[n];
                                }
                            }),
                            [2]
                        );
                                      ...
                                      return w(this, function (e) {
                                          switch (e.label) {
                                              case 0:
                                                  return t(), [4, g()];
                                              case 1:
                                                  return e.sent(), P || ((P = !0), Object(a.b)(), Object(a.c)(), Object(a.a)(), Object(l.a)()), Object(u.c)(), (C = !1), [2];
                                          }
                                      });
                                  });
                              }, 100),
            ...
            function _(e) {
                Object(s.a)("Setting locale", e), Object(u.d)({ language: (e || "").toLowerCase() });
            }
            if (void 0 === window[o.f] || !window[o.f].loaded) {
                var I = ".commonninja_component",
                    S = {},
                    M = [],
                    A = Object(i.a)(),
                    P = !1,
                    j = !1,
                    C = !1;
                (window[o.f] = { loaded: !0, init: N, destroy: E, reload: O, installedPlugins: S, setLocale: _ }),
